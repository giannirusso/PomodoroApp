...
extension ViewController {
    // Цвета для рабочеего времени и времени отдыха
    enum Color {
        static let workingTimeColor = UIColor(named: "redColor")
        static let restTimeColor = UIColor(named: "greenColor")
    }
    
    // Установка абочего время и времени отдыха
    enum TimeDuration {
        static let workingTime: Int = 15
        static let restTime: Int = 3
    }
}
